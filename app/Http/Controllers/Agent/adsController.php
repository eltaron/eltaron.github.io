...
class adsController extends Controller
{
    public function index(){
        if(Auth::user()->agent == 1) {
            ...
            return view('agent.ads.index')->with([
    ...
    public function create(){
        if(Auth::user()->agent == 1) {
            return view('agent.ads.create')->with([
    ...
    public function comments(){
        if(Auth::user()->agent == 1) {
            return view('agent.ads.comments')->with([
    ...
    public function store(Request $request){
        if(Auth::user()->agent == 1) {
            ...
            return redirect(gurl('ads'))->with('success','Advertisement Added Success');
        } else {
            return redirect(url('user/dashboard'));
        }
    }
    public function show($id){
        if(Auth::user()->agent == 1) {
            ...
            return view('agent.ads.show')->with([
    ...
    public function edit($id){
        if(Auth::user()->agent == 1) {
            ...
            $images   = Image::where('ads_id',$id)->get();
            if($ads){
                return view('agent.ads.edit')->with([
