    ...
    <div class="right-sidebar-body customscroll">
        <div class="right-sidebar-body-content">
            ...
            <div class="sidebar-btn-group pb-30 mb-10">
                <a href="{{ url('user/language/en') }}" class="btn btn-outline-primary  {{lang() == "er" ? 'active' : ''}} ">{{ trans('web.English') }}</a>
                <a href="{{ url('user/language/ar') }}" class="btn btn-outline-primary  {{lang() == "ar" ? 'active' : ''}}">{{ trans('web.Arabic') }}</a>
            </div>
