									...
									<ul>
                                        @foreach ($Allchats as $Allchat)
                                            <li class="{{$Allchat->id == $chat->id?'active':''}}">
                                                <a href="{{url('user/chat/show/'.$Allchat->id)}}">
							...
							<div class="chat-detail">
								<div class="chat-profile-header clearfix">
                                    ...
                                    @else
                                        <div class="right text-right">
                                            <div class="dropdown main_dropdown">
                                                <a class="btn btn-primary text-light" href="{{url('user/chat/invoice/'.$chat->id)}}">
                                                    {{ trans('web.Invoice') }}
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    ...
                    <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                        <form action="{{url('user/chat/complete')}}" method="POST">
                            @csrf
    ...
    <script>
        $(document).ready(function(){
            ...
            function fetch_user_chat_history(){
                $.ajax({
                    url:'{{url("user/chat/show/".$chat->id)}}',
                    type:'GET',
                    dataType:'json',
                    success:function(response){
