                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{gurl('dashboard')}}">{{ trans('web.Home') }}</a></li>
                            ...
                            <div class="container">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 col-lg-4 text-center border-bottom py-3">
                                        ...
                                        <strong class="d-block">{{ $advertise->rooms }}</strong>
                                    </div>
                                    <div class="col-md-6 col-lg-4 text-center border-bottom py-3">
                                        <span class="d-inline-block text-black mb-0 caption-text">{{trans('web.No Of Baths')}}</span>
                                        <strong class="d-block">{{ $advertise->baths }}</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
                            ...
                            <tbody>
                                @foreach ($comments as $comment)
                                    <tr>
                                        ...
                                        <td>{{\Illuminate\Support\Str::limit($comment->comment, 45, '...')}}</td>
        ...
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    <form action="{{gurl('ads/disactivate')}}" method="POST">
                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    <form action="{{gurl('ads/delete')}}" method="POST">
                        @csrf
