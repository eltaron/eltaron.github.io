...
<div class="main-container mt-5">
    ...
    <div class="pd-20 card-box mb-30">
        <div class="wizard-content">
            <form class="tab-wizard wizard-circle wizard" id="wizard" action="{{gurl('ads/create')}}" enctype="multipart/form-data" method="POST">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" required placeholder="{{trans('web.Title Of New Advertisement')}}" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
