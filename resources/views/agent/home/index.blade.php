    ...
    <div class="pd-ltr-20">
        <div class="card-box pd-20 height-100-p mb-30">
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <h2 class="weight-500 mb-10 text-capitalize">
                        {{ trans('web.Welcome back') }} <div class="weight-600 font-30 text-primary">{{Auth::user()->name}}</div>
                    </h2>
        ...
        <div class="card-box pd-20 height-100-p mb-30">
            ...
            <div class="row text-center">
                <div class="col-md-3 mb-2">
                    <a style="padding: 20px 0;" href="{{gurl('ads')}}" class="w-100 btn btn-primary"><i class="icon-copy fa fa-sticky-note" aria-hidden="true"></i> {{ trans('web.All Advertisments') }}</a>
                </div>
                <div class="col-md-3 mb-2">
                    <a style="padding: 20px 0;" href="{{gurl('blog')}}" class="w-100 btn btn-warning"><i class="icon-copy fa fa-newspaper-o" aria-hidden="true"></i> {{ trans('web.All Blogs') }}</a>
                </div>
                <div class="col-md-3 mb-2">
                    <a style="padding: 20px 0;" href="{{gurl('chat')}}" class="w-100 btn btn-dark"><i class="icon-copy fa fa-wechat" aria-hidden="true"></i> {{ trans('web.All Chats') }}</a>
                </div>
                <div class="col-md-3 mb-2">
                    <a style="padding: 20px 0;" href="{{gurl('messages/sent')}}" class="w-100 btn btn-success"><i class="icon-copy fa fa-envelope-open" aria-hidden="true"></i> {{ trans('web.All Messages') }}</a>
                </div>
                <div class="col-md-3 mb-2">
                    <a style="padding: 20px 0;" href="{{gurl('account')}}" class="w-100 btn btn-info"><i class="icon-copy fa fa-id-badge" aria-hidden="true"></i> {{ trans('web.Account') }}</a>
                </div>
                <div class="col-md-3 mb-2">
                    <a style="padding: 20px 0;" href="{{gurl('logout')}}" class="w-100 btn btn-danger"><i class="icon-copy fa fa-sign-out" aria-hidden="true"></i> {{ trans('web.Logout') }}</a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach ($latestads as $latestad)
                                <tr>
                                    ...
                                    <td>
                                        <a class="dropdown-item" href="{{gurl('ads/show/'.$latestad->id)}}"><i class="main-i dw dw-eye"></i> {{ trans('web.View') }}</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <tbody>
                            @foreach ($latestblogs as $latestblog)
                                <tr>
                                    ...
                                    <td>
                                        <a class="dropdown-item" href="{{gurl('blog/show/'.$latestblog->id)}}"><i class="main-i dw dw-eye"></i> {{ trans('web.View') }}</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
