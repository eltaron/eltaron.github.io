							...
							<div class="col-md-8 col-sm-12">
                                        ...
                                        @foreach ($blogs as $blog)
											...
											<div class="row no-gutters">
												<div class="col-lg-4 col-md-12 col-sm-12">
													<div class="blog-img" style="border-radius: 0;">
                                                        <img src="{{$blog->image->url}}" alt="" class="bg_img">
													</div>
												</div>
												<div class="col-lg-8 col-md-12 col-sm-12">
													<div class="blog-caption">
														<h4><a href="{{gurl('blog/show/'.$blog->id)}}">{{ \Illuminate\Support\Str::limit($blog->name, 50, '...') }}</a></h4>
                                                        ...
                                                        <div class="row" style="padding: 0 14px;">
                                                            <a href="{{gurl('blog/show/'.$blog->id)}}" class="btn btn-outline-primary">{{trans('web.Read More')}}</a>
                                                            <div class="dropdown text-right main-left">
                                                                <a class="btn btn-outline-primary dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                                                                    {{trans('web.Settings')}}
                                                                </a>
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <a class="dropdown-item view_ads" href="{{gurl('blog/edit/'.$blog->id)}}"
								...
								<div class="blog-pagination">
									<div class="blog-pagination mb-30">
                                        {{ $blogs->links('agent.pagination.index') }}
                                    </div>
								</div>
							</div>
									...
									<div class="latest-post">
										<ul>
                                            @foreach ($leatest_blogs as $leatest_blog)
                                                <li>
                                                    <h4><a href="{{gurl('blog/show/'.$leatest_blog->id)}}">{{ \Illuminate\Support\Str::limit($leatest_blog->name, 50, '...') }}</a></h4>
            ...
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    ...
                    <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                        <form action="{{gurl('blog/allow_comment')}}" method="POST">
                            @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    ...
                    <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                        <form action="{{gurl('blog/activate')}}" method="POST">
                            @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    ...
                    <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                        <form action="{{gurl('blog/delete_ads')}}" method="POST">
                            @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    ...
                    <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                        <form action="{{gurl('blog/disactivate_ads')}}" method="POST">
                            @csrf
