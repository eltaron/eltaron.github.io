                            ...
                            <div class="dropdown-menu dropdown-rtl" aria-labelledby="dropdownMenuButton">
                                <ul class="pro-body">
                                    <li class="dropdown-item" >
                                        <a href="{{ aurl('language/ar') }}" class="dropdown-item">&nbsp; <img
                                                style="height: 19px;margin-top: 5px;"
                                                src="{{ asset('admin') }}/src/images/ar.jpg" alt="">
                                            {{ trans('web.Arabic') }}</a>
                                    </li>
                                    <li class="dropdown-item" >
                                        <a href="{{ aurl('language/en') }}" class="dropdown-item">&nbsp; <img
                                                style="height: 19px;margin-top: 5px;"
                                                src="{{ asset('admin') }}/src/images/en.jpg" alt="">
                                            {{ trans('web.English') }}</a>
                                    </li>
		...
		<div class="container main_container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="{{ asset('admin') }}/vendors/images/mobile-login-animate.svg" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">{{trans('web.Login To .....')}}</h2>
						...
						<form method="POST" action="{{ aurl('login') }}">
                            @include('admin.includes.messages')
                            @csrf
							<div class="select-role">
                                <div class="input-group custom">
                                    <input type="text" class="form-control form-control-lg" name="email" placeholder="{{trans('web.Email')}}">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="input-group mb-0">
                                            <button class="btn btn-primary btn-lg btn-block" type="submit">{{trans('web.Sign In')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
