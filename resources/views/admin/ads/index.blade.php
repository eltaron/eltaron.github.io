        ...
        <div class="min-height-200px">
            ...
            <div class="product-wrap">
                                        ...
                                        <div class="product-box row" style="border-radius: 0;">
                                            ...
                                            <div class="product-caption col-md-8">
                                                <h3 class="property-title mb-2">
                                                    <a href="{{aurl('ads/show/'.$advertisment->id)}}">{{ \Illuminate\Support\Str::limit($advertisment->name, 50, '...') }}</a></h3>
                                                ...
                                                <div class="row">
                                                    <a href="{{aurl('ads/show/'.$advertisment->id)}}" class="btn btn-outline-primary">{{ trans('web.Read More') }}</a>
                                                    <div class="dropdown text-right main-left">
                                                        <a class="btn btn-outline-primary dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                                                            {{ trans('web.Settings') }}
                                                        </a>
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                            <a class="dropdown-item view_ads" href="{{aurl('ads/edit/'.$advertisment->id)}}"
                ...
                <div class="blog-pagination mb-30">
                    {{ $advertisments->links('admin.pagination.index') }}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    <form action="{{aurl('ads/allow_comment')}}" method="POST">
                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    <form action="{{aurl('ads/activate')}}" method="POST">
                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    <form action="{{aurl('ads/delete_ads')}}" method="POST">
                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    <form action="{{aurl('ads/disactivate_ads')}}" method="POST">
                        @csrf
