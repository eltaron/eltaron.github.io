                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                        <a class="dropdown-item" href="{{aurl('invoice/show/'.$invoice->id)}}"><i class="main_i dw dw-eye"></i>{{ trans('web.View') }}</a>
                                                        <a class="dropdown-item delete_ads" href="#" data-id="{{ $invoice->id }}"><i class="main_i dw dw-delete-3"></i>{{ trans('web.Delete') }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    ...
                    <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                        <form action="{{aurl('invoice/delete')}}" method="POST">
                            @csrf
                            <input type="hidden" name="invoice_id" id="user_id">
                            <div class="row">
                                <div class="col-6">
